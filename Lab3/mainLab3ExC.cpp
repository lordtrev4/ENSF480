...
// template void print(LookupTable<int, Customer>& lt);
// template void try_to_find(LookupTable<int, Customer>& lt, int key);
...
template void print<int, Customer>(LookupTable<int, Customer>& lt);
template void try_to_find<int, Customer>(LookupTable<int, Customer>& lt, int key);
